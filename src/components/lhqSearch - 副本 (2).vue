<template>
  <div class="proSearch_container">
    ...
    <div class="lhq_header">
      ...
      <div class="clearfix tag-item" v-if="tabCurrent == 0">
          <p>
      ...
      <div class="clearfix tag-item" v-else-if="tabCurrent == 1">
        <!-- <p>
          ...
          <span @click="winProduct(2)">查询</span>
        </p> -->
        <p>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      winProduct(){
        if(this.keyWords != ""){
          if(this.tabCurrent == 4 && this.keyWords.length < 3){
            
          }else{
            this.$router.push({path:'/proSearch/products', query: {words:this.keyWords,type:this.tabCurrent,categoryName:"",mb001:this.mb001}});
          }
          // if(this.tabCurrent == 3){ //发动机
          //   this.$router.push({path:'/proSearch/lhqList', query: {words:this.keyWords,categoryName:"",mb001:this.mb001}});
          // }else{
          //   this.$router.push({path:'/proSearch/products', query: {words:this.keyWords,type:this.tabCurrent,categoryName:"",mb001:this.mb001}});
          // }
      ...
      //选择车系
      barandList(){
        this.$router.push({path:'/proSearch/dhxqList', query:{title:this.$route.title,mb001:this.mb001}});
      },
      //tab查询分类
      changeTab(e){
        this.tabCurrent = e;
      ...
      //点击产品类别
      openWin(e){
       this.$router.push({path:'/proSearch/products', query: {words:this.keyWords,type:'5',categoryName:this.cateListText[e],mb001:this.mb001}});
      },
    }
  }
</script>
